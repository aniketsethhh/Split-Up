...
export const TESTIMONIALS = [
  {
    quote:
      "Ye babu rao ka style hai! With Split-Up, I finally stopped getting confused about who paid for what!",
    name: "Babu Rao",
    image: "/logos/babubhaiya.png",
    role: "Rental Property Manager",
  },
  {
    quote:
      "Split-Up's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
    name: "Raju",
    image: "/logos/raju.jpg",
    role: "Stock Market Expert",
  },
  {
    quote:
      "If that I have Split-Up, Raju wont get away with selling my shoes and coat! I'll add to his debt!",
    name: "Shyam",
    image: "/logos/shyam.png",
    role: "Job Searcher",
  },
];